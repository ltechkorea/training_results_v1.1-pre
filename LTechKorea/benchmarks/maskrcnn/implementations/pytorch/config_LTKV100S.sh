...
export EXTRA_CONFIG="SOLVER.BASE_LR 0.12 \
...
#export EXTRA_CONFIG="${EXTRA_CONFIG} \
...
export CONT=mlperf-nvidia:object_detection
export DATADIR=/opt/data/Dataset/training/coco

...
export DATADIR="/opt/data/Dataset/training/bert_data/2048_shards_uncompressed"
#export EVALDIR="/raid/datasets/bert/hdf5/v1p0_ref/eval_uncompressed"
export EVALDIR="/opt/data/Dataset/training/bert_data/eval_set_uncompressed"
#export DATADIR_PHASE2="/raid/datasets/bert/hdf5/v1p0_ref/4096_shards_uncompressed"
export DATADIR_PHASE2="/opt/data/Dataset/training/bert_data/2048_shards_uncompressed"
...
export CHECKPOINTDIR_PHASE1="/opt/data/Dataset/training/bert_data"
#Optional
